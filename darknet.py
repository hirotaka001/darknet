...
class Darknet():
    def __init__(self, config=b"cfg/yolov3-voc.cfg", model=b"backup/yolov3-voc_final.weights",
        ...
        self.net = load_net(b"cfg/yolov3-voc.cfg", b"backup/yolov3-voc_final.weights", 0)
        self.meta = load_meta(b"cfg/voc.data")
